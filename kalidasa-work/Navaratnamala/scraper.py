...
def extract_verses(soup: BeautifulSoup) -> List[Dict[str, str]]:
    """
    Extract verses from the Navaratnamala webpage.
...
def process_url(url: str) -> List[Dict[str, str]]:
    ...
    for verse in verses:
        ...
        ref = f'नवरत्नमाला->{english_number}'
...
def main():
    # URL for Navaratnamala
    url = "https://sanskritdocuments.org/doc_devii/navaratnamala.html"
