...
def extract_verses(soup: BeautifulSoup) -> List[Dict[str, str]]:
    """
    Extract verses from the Gangashtakam webpage.
...
def convert_devanagari_to_english(number: str) -> str:
    ...
    Args:
        number (str): Devanagari number string (e.g., "१")
        
    Returns:
        str: English number string (e.g., "1")
    """
...
def process_url(url: str) -> List[Dict[str, str]]:
    ...
    for verse in verses:
        ...
        ref = f'गङ्गाष्टकम्->{english_number}'
...
def main():
    # URL for Gangashtakam
    url = "https://sanskritdocuments.org/doc_devii/gangAShTakamkAlidAsa2.html"
